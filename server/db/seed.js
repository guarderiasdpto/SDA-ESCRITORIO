...
// ============================================================
// SECCIÓN: LÓGICA DE POBLACIÓN (SEMILLA MAESTRA)
// ============================================================
...
async function run() {
  ...
  try {
    ...
    // Inserción de catálogo de Puntos de Control (Coordinadora Zonal 1)
    await pool.query(`
      ...
      (9, 1, NULL, '1 y 3', '1 y 2 y 4', 'FOS', 'Atención de la salud', 'Cuidados', 'Bajo', 0.23, 'En los casos que se requiera se realiza el traslado de las niñas y niños a la unidad médica de apoyo o al servicio de urgencias más cercano y los casi de lesión física con sospecha de maltrato a segundo nivel.'),
      ...
      (87, 1, NULL, '2 y 3', '3 y 4', 'GES', 'Acciones administrativas', 'Bajas de niñas y niños', 'Bajo', 0.23, 'Para los casi de las o los niños con ocho o más inasistencias consecutivas se realizaron las acciones de localización correspondientes.'),
      (88, 1, NULL, '2 y 3', '3 y 4', 'GES', 'Acciones administrativas', 'Inscripción', 'Medio', 0.45, 'Para los casi donde in el proceso de verificación de vigencia de derechos hayan existido variaciones se aplica el procedimiento normado.'),
      ...
      (98, 1, NULL, '1 y 2 y 3 y 4', '1 y 2 y 3 y 4', 'FOS', 'Seguimiento de la salud', 'Atención médica', 'Medio', 0.45, 'Los casi que requirieron atención médica de urgencia están registrados in el Reporte de logros e incidencias diarias.'),
      ...
      (101, 1, NULL, '1 y 2 y 3 y 4', '1 y 2 y 3 y 4', 'FOS', 'Seguimiento de la salud', 'Atención médica', 'Medio', 0.45, 'Los casi sujetos a vigilancia epidemiológica y brotes de enfermedades transmisibles se notifican y registran conforme a lo normado.'),
    ...
    // Inserción de catálogo de Puntos de Control (Coordinadora Zonal 2)
    await pool.query(`
      INSERT INTO pc_catalogo (numero, coordinadora_zonal, dia_aplicacion, metodo_presencial, metodo_remoto, proceso, estandar, elemento_medible, nivel_riesgo, ponderacion, descripcion) VALUES
    ...
    console.log('[Seed] Catálogo CZ2 completado.');
